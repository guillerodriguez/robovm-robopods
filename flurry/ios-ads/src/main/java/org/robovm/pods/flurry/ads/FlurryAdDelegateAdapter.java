...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/FlurryAdDelegateAdapter/*</name>*/ 
    ...
    @Deprecated
    @NotImplemented("spaceShouldDisplay:forType:")
    public boolean spaceShouldDisplay(String adSpace, FlurryAdType type) { return false; }
    ...
    public String appSpotMillennialAppKey() { return null; }
    @NotImplemented("appSpotMillennialInterstitalAppKey")
    public String appSpotMillennialInterstitalAppKey() { return null; }
    @NotImplemented("appSpotInMobiAppKey")
    public String appSpotInMobiAppKey() { return null; }
    @NotImplemented("appSpotFANAppPlacementID")
    public String appSpotFANAppPlacementID() { return null; }
    @NotImplemented("appSpotAdMobPublisherID")
    public String appSpotAdMobPublisherID() { return null; }
    @NotImplemented("appSpotMobclixApplicationID")
    public String appSpotMobclixApplicationID() { return null; }
    @NotImplemented("appSpotJumptapPublisherID")
    public String appSpotJumptapPublisherID() { return null; }
    @NotImplemented("appSpotJumptapSiteID")
    public String appSpotJumptapSiteID() { return null; }
    @NotImplemented("appSpotJumptapBannerAdSpotID")
    public String appSpotJumptapBannerAdSpotID() { return null; }
    @NotImplemented("appSpotJumptapLeaderboardAdSpotID")
    public String appSpotJumptapLeaderboardAdSpotID() { return null; }
    @NotImplemented("appSpotJumptapMediumRectangleAdSpotID")
    public String appSpotJumptapMediumRectangleAdSpotID() { return null; }
    @Deprecated
    @NotImplemented("appSpotRootViewController")
    public NSObject appSpotRootViewController() { return null; }
    @NotImplemented("appSpotAccelerometerEnabled")
    public boolean appSpotAccelerometerEnabled() { return false; }
    /*</methods>*/
}
