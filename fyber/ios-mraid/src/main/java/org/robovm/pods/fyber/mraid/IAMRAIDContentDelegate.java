...
/*<visibility>*/public/*</visibility>*/ interface /*<name>*/IAMRAIDContentDelegate/*</name>*/ 
    ...
    void MRAIDAdWillResize(IAMRAIDContentController contentController, @ByVal CGRect frame);
    @Method(selector = "IAMRAIDContentController:MRAIDAdDidResizeToFrame:")
    void MRAIDAdDidResize(IAMRAIDContentController contentController, @ByVal CGRect frame);
    @Method(selector = "IAMRAIDContentController:MRAIDAdWillExpandToFrame:")
    void MRAIDAdWillExpand(IAMRAIDContentController contentController, @ByVal CGRect frame);
    @Method(selector = "IAMRAIDContentController:MRAIDAdDidExpandToFrame:")
    void MRAIDAdDidExpand(IAMRAIDContentController contentController, @ByVal CGRect frame);
